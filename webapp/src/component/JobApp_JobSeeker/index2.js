...
function Rejectedjobs() {
    ...
    let getdata = async () => {
      let raw = await axios.get("http://localhost:3001/jobRejected")
      ...
      <LeftSidefilters/>
        ...
        <div className='container-m'>
          ...
          <div className='myButtons'>
            ...
            <Link to='/acceptedjobs'>   <Button variant="outline-success" className="hoverButton "  >Accepted</Button>{' '}</Link>
            <Link to='/rejectjobs'>  <Button variant="outline-danger" className="hoverButton active">Rejected</Button>{' '}</Link>
          </div>
