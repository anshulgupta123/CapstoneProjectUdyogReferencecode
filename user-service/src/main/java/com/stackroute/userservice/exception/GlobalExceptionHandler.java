...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<Object> ResponseEntityExceptionHandler(Exception ex, WebRequest request)
		...
		errorDetails.setErrorCode(environment.getProperty(Constants.DEFAULT_EXCEPTION_CODE));
		errorDetails.setErrorDetails(ex.getMessage());
		return new ResponseEntity<Object>(new Response<Object>(errorDetails, 
				environment.getProperty(Constants.FAILURE_CODE)), HttpStatus.INTERNAL_SERVER_ERROR);
